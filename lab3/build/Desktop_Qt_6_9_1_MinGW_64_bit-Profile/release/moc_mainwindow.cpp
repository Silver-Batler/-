...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onBooksReceived'
        QtMocHelpers::SlotData<void(const QList<Book> &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onBookCreated'
        QtMocHelpers::SlotData<void(const Book &)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'onBookUpdated'
        QtMocHelpers::SlotData<void(const Book &)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'onBookDeleted'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onBooksReceived((*reinterpret_cast< std::add_pointer_t<QList<Book>>>(_a[1]))); break;
        case 1: _t->onBookCreated((*reinterpret_cast< std::add_pointer_t<Book>>(_a[1]))); break;
        case 2: _t->onBookUpdated((*reinterpret_cast< std::add_pointer_t<Book>>(_a[1]))); break;
        case 3: _t->onBookDeleted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
